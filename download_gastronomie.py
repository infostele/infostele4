...
# -*- coding: utf-8 -*-
"""
download_gastronomie.py — Laedt alle Seiten des gmw-gastronomie-ww Endpoints
in einzelne lokale Dateien gastro-1.json, gastro-2.json, ...
...
Verwendung:
    python download_gastronomie.py
...
ENDGastrobetriebNT_SLUG = "gmw-gastronomie-ww"
PAGE_SIZE     = 50                  # ~764 Gastro / 50 = ~16 Seiten
ANZ_SEITEN    = 18                  # 16 erwartet, 2 Sicherheits-Puffer
OUTPUT_DIR    = "."                 # aktuelles Verzeichnis
DATEINAMEN    = "gastro-{n}.json"  # gastro-1.json … gastro-4.json
...
def baue_url(seite):
    base = "https://data.rlp-tourismus.de/api/v4/endpoints/" + ENDGastrobetriebNT_SLUG
    params = {
...
def main():
    print("╔════════════════════════════════════════════════════════╗")
    print("║  DataHub Gastronomie - Download                       ║")
    print("║  Endpoint: " + ENDGastrobetriebNT_SLUG.ljust(43) + "║")
    ...
    print("  python build_gastronomie.py gastro-*.json -o gastro-datahub.js")
    print()
    print("Unter Windows-CMD ohne Shell-Glob:")
    print("  python build_gastronomie.py gastro-1.json gastro-2.json "
          "gastro-3.json gastro-4.json -o gastro-datahub.js")
    return 0
