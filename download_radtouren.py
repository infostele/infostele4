...
# -*- coding: utf-8 -*-
"""
download_radtouren.py — Laedt alle Seiten des gmw-radtouren-ww Endpoints
in einzelne lokale Dateien rad-1.json, rad-2.json, ...
...
ENDPOINT_SLUG = "gmw-radtouren-ww"
PAGE_SIZE     = 50                  # 54 Touren / 50 pro Seite = 2 Seiten
ANZ_SEITEN    = 2                   # 54 Touren passen in 2 Seiten
OUTPUT_DIR    = "."                 # aktuelles Verzeichnis
DATEINAMEN    = "rad-{n}.json"  # rad-1.json … rad-4.json
...
def main():
    print("╔════════════════════════════════════════════════════════╗")
    print("║  DataHub Radtouren - Download                       ║")
    ...
    print("  python build_radtouren.py rad-*.json -o radtouren-datahub.js")
    print()
    print("Unter Windows-CMD ohne Shell-Glob:")
    print("  python build_radtouren.py rad-1.json rad-2.json "
          "rad-3.json rad-4.json -o radtouren-datahub.js")
    return 0
