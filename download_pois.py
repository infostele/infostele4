...
# -*- coding: utf-8 -*-
"""
download_pois.py — Laedt alle Seiten des gmw-pois-ww Endpoints
in einzelne lokale Dateien pois-1.json, pois-2.json, ...
...
ENDPOINT_SLUG = "gmw-pois-ww"
PAGE_SIZE     = 50                  # ~1943 POIs / 50 pro Seite = 40 Seiten
ANZ_SEITEN    = 45                  # 40 erwartet, 5 Sicherheits-Puffer
OUTPUT_DIR    = "."                 # aktuelles Verzeichnis
DATEINAMEN    = "pois-{n}.json"  # pois-1.json … pois-4.json
...
def main():
    ...
    print("  python build_pois.py pois-*.json -o pois-datahub.js")
    print()
    print("Unter Windows-CMD ohne Shell-Glob:")
    print("  python build_pois.py pois-1.json pois-2.json "
          "pois-3.json pois-4.json -o pois-datahub.js")
    return 0
