...
# -*- coding: utf-8 -*-
"""
download_wandertouren.py — Lädt alle Seiten des gmw-wandertouren-ww Endpoints
in einzelne lokale Dateien wandern-1.json, wandern-2.json, ...
...
Verwendung:
    python download_wandertouren.py
...
ENDPOINT_SLUG = "gmw-wandertouren-ww"
PAGE_SIZE     = 50                  # 200 Touren / 50 pro Seite = 4 Seiten
ANZ_SEITEN    = 4                   # einfach 4 Seiten probieren; wenn weniger Daten da sind, bricht's sauber ab
OUTPUT_DIR    = "."                 # aktuelles Verzeichnis
DATEINAMEN    = "wandern-{n}.json"  # wandern-1.json … wandern-4.json
...
def main():
    print("╔════════════════════════════════════════════════════════╗")
    print("║  DataHub Wandertouren - Download                       ║")
    ...
    print("  python build_wandertouren.py wandern-1.json wandern-2.json "
          "wandern-3.json wandern-4.json -o wandertouren-datahub.js")
    return 0
